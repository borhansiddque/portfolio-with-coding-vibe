          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <div className="relative bg-gray-900/80 p-3 sm:p-4 md:p-6 lg:p-8 rounded-2xl border border-green-400/20 font-mono">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-green-400 text-xs sm:text-sm md:text-base">
                    profile.js
                  </span>
                </div>
                ...
                <div className="text-xs sm:text-sm md:text-base space-y-1 md:space-y-2 overflow-x-auto">
                  ...
                  <div className="ml-1 sm:ml-2 md:ml-4">
                    ...
                    <span className="text-yellow-400">'Borhan Siddque'</span>,
                  </div>
                  <div className="ml-1 sm:ml-2 md:ml-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
              {stats.map(({ icon: Icon, label, value, color }) => (
                <div
                  key={label}
                  className="text-center p-4 md:p-6 bg-gray-900/50 rounded-xl border border-gray-700/50 hover:border-green-400/30 transition-all duration-300 group"
                >
                  <div className="relative">
                    <PiBracketsCurlyLight
                      className="absolute top-0 left-0 text-green-400/30 hidden md:block"
                      size={32}
                    />
                    <Icon
                      size={24}
                      className={`${color} mx-auto mb-3 relative z-10 md:w-8 md:h-8`}
                    />
                  </div>
                  <div className="text-xl md:text-2xl font-bold text-white mb-1 font-mono">
                    {value}
                  </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-900/80 p-4 md:p-6 rounded-2xl border border-blue-400/20">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-blue-400 font-mono ml-2 text-sm md:text-base">
                  contact.json
                </span>
              </div>
